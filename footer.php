...
<div class="modal" data-modal-id="login">
  <div class="modal_content">
    <div class="modal_content_close">
      <img src="<?php bloginfo('template_url'); ?>/img/close-modal.svg" width="15px">
    </div>
    <div>
      <?php _e('Вам нужно ', 'restx'); ?><a href="/member-login" class="blue-links"><?php _e('Войти','restx'); ?></a> <?php _e('или ', 'restx'); ?> <a href="/member-register" class="blue-links"><?php _e('Зарегистрироваться', 'restx'); ?></a>
    </div>
  </div>
</div>
<!-- Конец Модальное окно, войти или зарегистрироваться -->
