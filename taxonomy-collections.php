		...
		<div class="w-full lg:w-9/12 pl-0 lg:pl-8">
			...
			<div class="block mb-4">
		      ...
		      <ul>
			      ...
			      <li itemprop='itemListElement' itemscope itemtype='http://schema.org/ListItem'>
			        <a itemprop="item" href="<?php echo get_term_link(get_queried_object()->term_id, 'collections'); ?>">
			...
			<h1 class="text-2xl lg:text-4xl mb-6"><?php _e('Снять жилье в Украине', 'restx'); ?>: <?php single_term_title(); ?></h1>
			<!-- Подборки жилья -->
			<div class="mb-2">
				<ul class="flex flex-wrap -mx-2">
					...
					foreach ( $collections as $col ): ?>
						<?php if($col): ?>
						  <?php if ($col->term_id === get_queried_object()->term_id) {
						  	$classActive = 'active';
						  } ?>
							<li class="mb-6 px-2">
								<a href="<?php echo get_term_link($col->term_id, 'collections'); ?>" class="blue-tabs bg-gray-200 px-3 py-2 rounded-lg <?php echo $classActive; ?>">
									<?php echo $col->name; ?>
								</a>
							</li>
