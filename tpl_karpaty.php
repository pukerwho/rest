...
<div class="container mx-auto px-2 lg:px-0 pt-20 lg:pt-12 lg:pb-12">
	<div class="flex flex-col lg:flex-row">
				...
				<div class="block lg:hidden mb-6">
					<div class="flex">
					    ...
					    <ul>
					      ...
					      <li itemprop='itemListElement' itemscope itemtype='http://schema.org/ListItem'>
					        <a itemprop="item" href="<?php echo get_page_url('tpl_karpaty') ?>">
					          <span itemprop="name"><?php _e( 'Отдых в Карпатах', 'restx' ); ?></span>
					        </a>
		...
		<div class="w-full lg:w-9/12 pl-0 lg:pl-8">
			...
			<h1 class="text-2xl lg:text-4xl mb-6"><?php _e( 'Отдых в Карпатах', 'restx' ); ?></h1>
			<!-- Catalog Hotels -->
