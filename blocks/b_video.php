				...
				<div class="mb-5">
					<div class="my-table">
						...
						<div class="table-text">
							<h2>Подписывайтесь на наш канал</h2>
							<p>Классные видео про украинские курорты</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row mb-5">
			<div class="col-md-12">
				<div class="button-more text-center">
					<a href="https://www.youtube.com/channel/UC8aL1GxvTKVEdzp8Za3Gqig?sub_confirmation=1" target="_blank"><div class="btn">YouTube канал</div></a>
				</div>
			</div>
		</div>
	</div>
