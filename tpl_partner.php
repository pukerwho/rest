		...
		<div class="row mb-5">
			<div class="col-md-4 text-center">
				<div class="p_partner__box">
					...
					<a href="<?php echo home_url(); ?>/tarif-base/" class="text-dark">
			...
			<div class="col-md-4 text-center">
				<div class="p_partner__box">
					...
					<a href="<?php echo home_url(); ?>/tarif-standart/" class="text-dark">
			...
			<div class="col-md-4 text-center">
				<div class="p_partner__box">
					...
					<a href="<?php echo home_url(); ?>/tarif-premium/" class="text-dark">
		...
		<div class="row justify-content-center mb-5">
			<div class="col-md-8">
				<div class="d-flex align-items-center">
					<div class="p_partner__circle mr-3 mb-4 p_partner__circle-first" style="background-color: #efb880;">
						<img src="<?php bloginfo('template_url') ?>/img/calculator.svg" alt="" width="35px">
					</div>
					<div class="p_partner__text">
						<span class="p_partner__red mr-2">
							01
						</span>
						<span>
				...
				<div class="d-flex align-items-center">
					<div class="p_partner__circle mr-3 mb-4" style="background-color: #90ddee;">
						<img src="<?php bloginfo('template_url') ?>/img/clipboard.svg" alt="" width="35px">
					</div>
					<div class="p_partner__text">
						<span class="p_partner__red mr-2">
							02
				...
				<div class="d-flex align-items-center mb-5">
					<div class="p_partner__circle mr-3 ">
						<img src="<?php bloginfo('template_url') ?>/img/hand.svg" alt="" width="50px">
					</div>
					<div class="p_partner__text">
						<span class="p_partner__red mr-2">
							03
