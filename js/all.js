...
// Плавная пракрутка на странице Citylist
let citylistSubjects = document.querySelectorAll('.citylist_subjects a[href*="#"]');

for (citylistSubject of citylistSubjects) {
  if (citylistSubject) {
    citylistSubject.addEventListener('click', function(e){
      subjectId = this.getAttribute('href');
      scrollToAnchor(subjectId);
    })
  }
}
